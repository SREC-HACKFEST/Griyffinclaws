...
public class GenerateReportsAdapter extends RecyclerView.Adapter<GenerateReportsAdapter.ReportViewHolder> {

    private Context context;
    private List<StudentModel> students;

    public GenerateReportsAdapter(Context context, List<StudentModel> students) {
    ...
    public void onBindViewHolder(@NonNull ReportViewHolder holder, int position) {
        ...
        holder.buttons.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
